 ...
 */
final class Version20220409122436 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE user_id user_id INT DEFAULT NULL, CHANGE total total DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE menu_commande DROP date, CHANGE command_id command_id INT DEFAULT NULL, CHANGE menu_id menu_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande CHANGE user_id user_id INT NOT NULL, CHANGE etat etat VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`, CHANGE total total INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE menu_commande ADD date DATE NOT NULL, CHANGE menu_id menu_id INT NOT NULL, CHANGE command_id command_id INT NOT NULL');
