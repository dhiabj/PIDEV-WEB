 ...
 */
final class Version20220409124838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE promotion CHANGE datelimite datelimite DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE promotion CHANGE datelimite datelimite DATETIME DEFAULT NULL');
