 ...
 * Livraison
 *
 * @ORM\Table(name="livraison", indexes={@ORM\Index(name="livraison_ibfk_2", columns={"livreur_id"}), @ORM\Index(name="comande_id", columns={"commande_id"}), @ORM\Index(name="livraison_ibfk_1", columns={"user_id"})})
